...
export function SectionCards() {
  return (
    <div className="*:data-[slot=card]:from-primary/5 *:data-[slot=card]:to-card dark:*:data-[slot=card]:bg-card grid grid-cols-1 gap-4 px-4 *:data-[slot=card]:bg-gradient-to-t *:data-[slot=card]:shadow-xs lg:px-6 @xl/main:grid-cols-2 @5xl/main:grid-cols-4">
      ...
      <Card className="@container/card bg-cyan-100 dark:bg-cyan-900 hover:bg-cyan-200 hover:dark:bg-cyan-800 border-b-cyan-500 border-b-4">
        <CardHeader>
          <CardDescription>Partial Success</CardDescription>
          <CardTitle className="text-2xl font-semibold tabular-nums @[250px]/card:text-3xl">
            45,678
          ...
          <CardAction>
            <Badge className="bg-cyan-500 text-white" variant="default">
              <IconTrendingUp />
              +12.5%
            </Badge>
          </CardAction>
      ...
      <Card className="@container/card bg-pink-100 dark:bg-pink-900 hover:bg-pink-200 hover:dark:bg-pink-800 border-b-pink-500 border-b-4">
        <CardHeader>
          <CardDescription>Overall Files</CardDescription>
          <CardTitle className="text-2xl font-semibold tabular-nums @[250px]/card:text-3xl">
            4.5%
          ...
          <CardAction>
            <Badge className="bg-pink-200 text-black" variant="default">
              <IconTrendingUp />
              +4.5%
            </Badge>
          </CardAction>
